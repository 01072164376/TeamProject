                        ...
                        <div class="title_wrap">
                            <h1>
                                ...
                                <span class="title_area">
                                    <span class="category addCategoryCustom">경제</span>
                                    <span class="title">인플레이션에서 살아남기</span>
                                </span>
                            </h1>
                                        ...
                                        <div class="subtitle_content">
                                            ...
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                ...
                                                <span style="letter-spacing: -0.1pt; font-family: 나눔고딕; font-size: 12pt;">
                                                    200만 구독자의 열렬한 사랑을 받는 '삼프로TV'는 경제 분야 1위 유튜브 채널이다. 내로라하는 TOP급 전문가들이 출연해
                                                    국내외 시황 등의 정보를 나누는데, 요즘처럼 금리가 뛰어오르고 환율이 고공행진하는 등 혼란스러운 시장이 펼쳐질 때 
                                                    독자들이 한마음 한 뜻으로 찾는 사람이 있다.바로 신한은행 WM그룹의 부부장, 오건영 저자이다. 
                                                    '글로벌 경제 1타 강사'로 불리는 오건영 저자의 또 다른 애칭은 '대한민국 최고의 Fed(연준)전문가'다. 
                                                    글로벌 시장의 폭주를 막아줄 유일한 파수꾼이 Fed이므로, 이들의 행보가 곧 문제를 해결해줄 실마리가 될 것이다. 
                                                    오건영 저자의 해설을 들으며 그들의 과거 행적을 되짚어보면 경제는 앞으로 어떤 움직임을 보일지, 그런 환경에서
                                                    우리가 취해야 할 안전한 투자법은 무엇일지 저절로 감이 올 것이다.
                                                </span>
                                            </p>
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                <span style="letter-spacing: -0.1pt; font-size: 12pt;"> </span>
