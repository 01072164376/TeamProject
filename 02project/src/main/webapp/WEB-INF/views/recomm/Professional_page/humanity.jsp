...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="ex/resources/webstyle.css">
                ...
                <div class="uccst14_detail_wrap">
                    <div class="uccst14_detail">
                        <div class="title_wrap">
                            <h1>
                                <span class="date">전문기관 추천도서</span>
                                <span class="title_area">
                                    <span class="category addCategoryCustom">시사</span>
                                    <span class="title">이기적 인류의 공존 플랜</span>
                                </span>
                            </h1>
                                        ...
                                        <div class="subtitle_content">
                                            ...
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                ...
                                                <span style="letter-spacing: -0.1pt; font-family: 나눔고딕; font-size: 12pt;">
                                                    코로나 팬데믹은 우리 사회가 품고 있던 균열을 가시화하며 기존의 세계를 유지해 온 구성원 간의 합의가 더 이상 유효하지 않음을 들어냈다. 
                                                    저소득층과 저기술 노동자, 돌봄 노동을  떠안은 여성과 자활하지 못하는 노인, 일회용품 사용 증가로 인해 한층 심각해진 환경 위기와 커져가는
                                                    국가 부채 앞에서 우리는 우리 사회의 안정망이 충분하지 못하다는 사실을 절감했다. 우리의 안전이 얼굴조차 본 적 없는 사람들의 책임 의식에 달리고,
                                                    생존을 위해서는 서로가 서로에게 의무가 다해야 하는 이때, 직면한 위기를 극복하고 모두가 더 나은 삶을 살수 있게 하는 방법은 무엇일까?
                                                    세계은행과 IMF, 영국 중앙은행을 거치며 다양한 세계 문제에 대응해온 런던 정치경제대학교의 총장 미노슈 샤피크는 고용불안정과 고령화,
                                                    기후 위기, 양극화 등 새로 부상하는 문제들을 해결하기 위해서는 새로운 사회계약이 필요하다고 지적하며, 더욱 많은 시민들을 포용하며 그들과
                                                    공존하는 사회계약의 청사진을 제시한다. 학자로서의 이론적 근거는 물론 행정가로서의 경험을 토대로 실현가능한 정책을 제안하는 이 책을 통해서
                                                    독자들은 현재 우리 사회에 꼭 필요한 사회계약의 구체적인 방향을 가늠할 수 있을 것이다.
                                                </span>
                                            </p>
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                <span style="letter-spacing: -0.1pt; font-size: 12pt;"> </span>
