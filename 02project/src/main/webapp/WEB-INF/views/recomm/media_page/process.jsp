                        ...
                        <div class="title_wrap">
                            <h1>
                                ...
                                <span class="title_area">
                                    ...
                                    <span class="title">공정하다는 착각</span>
                                </span>
                            </h1>
                                        ...
                                        <div class="subtitle_content">
                                            ...
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                ...
                                                <span style="letter-spacing: -0.1pt; font-family: 나눔고딕; font-size: 12pt;">
                                                    ...
                                                    기업은 정규직, 비정규직 비롯된 '공정 채용'문제로 혼란에 빠져 있고, 정치권에선 공정경제3법, 재난지원금 등의 대한
                                                    각기 다른 해석으로 떠들썩하다. 대통령은 "하나의 공정이 또 다른 불공정을 부르는 상황"을 언급하며 어려움을 토로하기도 했다. 
                                                    샌델은 이 책을 통해 우리가 노력하면 성공할 수 있다고 너무나도 당연히 생각해왔던 개인의 능력을 우선시하고 보상해주는
                                                    능력주의 이상이 근본적으로 크게 잘못되어 있다고 주장한다.
                                                </span>
                                            </p>
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                <span style="letter-spacing: -0.1pt; font-size: 12pt;"> </span>
