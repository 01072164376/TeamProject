                                        ...
                                        <div class="subtitle_content">
                                            ...
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                ...
                                                <span style="letter-spacing: -0.1pt; font-family: 나눔고딕; font-size: 12pt;">
                                                    발표하는 작품마다 독자들의 열광적인 지지를 받으며 한국문학의 대체불가한 작가로 자리매김한 정유정이
                                                    신작 '완전한 행복'으로 돌아왔다. 500여 쪽을 꽉 채운 압도적인 서사와 적재적소를 타격하는 속도감 있는 문장,
                                                    치밀하고 정교하게 쌓아올린 플롯과 독자의 눈에 작열하는 생생한 묘사로 정유정만의 스타일을 가감 없이 보여주는
                                                    한편, 더 완숙해진 서스펜스와 인간의 심연에 대한 밀도 높은 질문으로 가득 찬 수작이다.
                                                </span>
                                            </p>
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                <span style="letter-spacing: -0.1pt; font-size: 12pt;"> </span>
