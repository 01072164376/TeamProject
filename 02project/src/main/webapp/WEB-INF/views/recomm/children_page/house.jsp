...
<head>
    ...
    <style>
        ...
        <style>
            ...
            .buyer_area_a .buyer_box .anay_Tround_S {margin:0; background-color:#e5e5e5; width: 100px; height:100px; border-radius: 50%; -webkit-border-radius: 50%; -moz-border-radius: 50%; text-align: center; padding-top:30px;  font-size:16px; font-family: malgun, "Malgun Gothic", Dotum, 돋움, sans-serif; color:#111; font-weight:bold; line-height:1.4;}
            ...
            .star_area_a .star_box .anay_Tround_S {margin:0; background-color: #e5e5e5;width: 100px; height:100px; border-radius: 50%; -webkit-border-radius: 50%; -moz-border-radius: 50%; text-align: center; padding-top:30px; font-size:16px; font-family: malgun, "Malgun Gothic", Dotum, 돋움, sans-serif; color:#111; font-weight:bold; line-height:1.4;}
                ...
                <div class="uccst14_detail_wrap">
                    <div class="uccst14_detail">
                        <div class="title_wrap">
                            <h1>
                                <span class="date">어린이/청소년 추천도서</span>
                                <span class="title_area">
                                    <span class="category addCategoryCustom">소설</span>
                                    <span class="title">순례주택</span>
                                </span>
                            </h1>
                            <div class="board_info_area">
                                ...
                                <div class="book_info_wrap">
                                    <dl class="book_info">
                                        ...
                                        <dt>출판사</dt>
                                        <dd class="publicher">비룡소</dd>
                                        <dt>발행년도</dt>
                                        <dd class="year">2021</dd>
                                    </dl>
                                </div>
                            </div>
                                        ...
                                        <div class="subtitle_content">
                                            ...
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                ...
                                                <span style="letter-spacing: -0.1pt; font-family: 나눔고딕; font-size: 12pt;">
                                                    한국어린이도서상, IBBY 어너리스트 수상작가 유은실의 신작 청소년 소설 '순례주택' 코믹 발랄한 캐릭터 설정과
                                                    순례주택을 둘러싼 한바탕 대소동은 기발하면서도 유쾌하다. 약간은 막 가는 수림이네 네 식구가 쫄딱 망한 뒤,
                                                    돌아가신 외할아버지의 옛 여자친구의 빌라 '순례주택'으로 이사 들어가면서 벌어지는 이야기이다. 솔직하지 못한 엄마,
                                                    누군가에게 얹혀사는데 일가견 있는 아빠, 라면은 끓일 줄 모르고 컵라면에 물만 겨우 부을 줄 아는 언니까지, 졸지에
                                                    망한 수림이네 가족은 평소 업신여기던 순례주택으로 이사오게 된다.
                                                </span>
                                            </p>
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                <span style="letter-spacing: -0.1pt; font-size: 12pt;"> </span>
