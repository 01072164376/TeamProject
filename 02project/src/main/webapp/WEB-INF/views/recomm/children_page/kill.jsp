                        ...
                        <div class="title_wrap">
                            <h1>
                                ...
                                <span class="title_area">
                                    <span class="category addCategoryCustom">미스터리</span>
                                    <span class="title">죽이고 싶은 아이</span>
                                </span>
                            </h1>
                                        ...
                                        <div class="subtitle_content">
                                            ...
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                ...
                                                <span style="letter-spacing: -0.1pt; font-family: 나눔고딕; font-size: 12pt;">
                                                    2018년 '세계를 건너 너에게 갈게'를 발표한 이후 독바들의 뜨거운 호응을 받아온 이꽃님 작가가 강렬한 신작으로 돌아왔다. 
                                                    '죽이고 싶은 아이'는 한 여고생의 죽음을 둘러싼, 결코 평범하지 않은 이야기를 담아낸 작품이다. 작가는 이 소설이
                                                    진실과 믿음에 관한 이야기라고 말한다. 소설의 중심인물인 주연과 서은은 중학교 때부터 둘도 없는 단짝 친구다.
                                                    두 사람이 크게 싸운 어느 날, 학교 건물 뒤 공터에서 서은이 시체로 발견되고 가장 유력한 용의자로 주연이 체포된다. 
                                                    그런데 어찌 된 일인지 주연은 그날의 일이 도무지 기억나지 않는다.
                                                </span>
                                            </p>
                                            <p class="0" style="line-height: 170%; margin-right: 6px; margin-left: 6px;">
                                                <span style="letter-spacing: -0.1pt; font-size: 12pt;"> </span>
